...
import static io.awesome.gultube.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_NONE;
import static io.awesome.gultube.player.helper.PlayerHelper.MinimizeMode.MINIMIZE_ON_EXIT_MODE_POPUP;
...
public class PlayerHelper {
	...
	@SuppressLint("ConstantLocale") private static final Formatter stringFormatter = new Formatter(stringBuilder, Locale.getDefault());
	private static final NumberFormat speedFormatter = new DecimalFormat("0.##x");
	
	@Retention(SOURCE)
	@IntDef({MINIMIZE_ON_EXIT_MODE_NONE, MINIMIZE_ON_EXIT_MODE_POPUP})
	public @interface MinimizeMode {
		int MINIMIZE_ON_EXIT_MODE_NONE = 0;
		int MINIMIZE_ON_EXIT_MODE_POPUP = 1;
	}
	...
	private static String getMinimizeOnExitAction(@NonNull final Context context, final String key) {

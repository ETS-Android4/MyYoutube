package io.awesome.gultube.download.ui.adapter;
...
import io.awesome.gultube.BuildConfig;
import io.awesome.gultube.R;
import io.awesome.gultube.download.helper.DownloadMission;
import io.awesome.gultube.download.helper.FinishedMission;
import io.awesome.gultube.download.helper.Mission;
...
import io.awesome.gultube.download.ui.common.Deleter;
import io.awesome.gultube.download.ui.common.ProgressDrawable;
import io.awesome.gultube.download.util.Utility;
...
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_CONNECT_HOST;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_FILE_CREATION;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_HTTP_NO_CONTENT;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_INSUFFICIENT_STORAGE;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_NOTHING;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_PATH_CREATION;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_PERMISSION_DENIED;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_POSTPROCESSING;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_POSTPROCESSING_HOLD;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_POSTPROCESSING_STOPPED;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_PROGRESS_LOST;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_RESOURCE_GONE;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_SSL_EXCEPTION;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_TIMEOUT;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_UNKNOWN_EXCEPTION;
import static io.awesome.gultube.download.helper.DownloadMission.ERROR_UNKNOWN_HOST;

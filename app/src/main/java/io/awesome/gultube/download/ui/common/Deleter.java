package io.awesome.gultube.download.ui.common;
...
import io.awesome.gultube.download.service.DownloadManager.MissionIterator;
...
public class Deleter {
	...
	private void next() {
		...
		String msg = mContext.getString(R.string.msg_delete_successfully).concat(":\n").concat(items.get(0).storage.getName());
